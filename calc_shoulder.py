...
if __name__ == "__main__":
    ...
    # 어깨 구 시각화
    L_sphere = o3d.geometry.TriangleMesh.create_sphere(radius=0.015)
    L_sphere.translate(L_shoulder)
    L_sphere.paint_uniform_color([1.0, 0.0, 1.0])

    R_sphere = o3d.geometry.TriangleMesh.create_sphere(radius=0.015)
    R_sphere.translate(R_shoulder)
    R_sphere.paint_uniform_color([1.0, 0.0, 1.0])

    shoulder_center_sphere = o3d.geometry.TriangleMesh.create_sphere(radius=0.015)
